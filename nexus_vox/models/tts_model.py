...
from nexus_vox.models.mimi import build_mimi
from nexus_vox.models.model_state import _import_model_state, _is_safetensors_source
from nexus_vox.models.text_chunking import prepare_text_prompt, split_into_best_sentences
from nexus_vox.modules.stateful_module import (
    ModelState,
    StatefulModule,
    increment_steps,
    init_states,
)
from nexus_vox.quantization import RECOMMENDED_CONFIG, apply_dynamic_int8
from nexus_vox.utils.config import CONFIGS_DIR, Config, load_config
from nexus_vox.utils.utils import (
...
from nexus_vox.utils.weights_loading import (
    ...
    def load_model(
        ...
        Args:
            ...
            quantize: If True, apply dynamic int8 quantization to the transformer's
                ...
                For optimized performance, install torchao: ``pip install nexus-vox[quantize]``
