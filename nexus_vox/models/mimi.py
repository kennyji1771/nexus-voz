...
from nexus_vox.modules.conv import pad_for_conv1d
from nexus_vox.modules.dummy_quantizer import DummyQuantizer
from nexus_vox.modules.resample import ConvDownsample1d, ConvTrUpsample1d
from nexus_vox.modules.seanet import SEANetDecoder, SEANetEncoder
from nexus_vox.modules.stateful_module import ModelState
from nexus_vox.modules.transformer import ProjectedTransformer
from nexus_vox.utils.config import MimiConfig
...
def build_mimi(config: MimiConfig) -> MimiModel:
    """MimiModel from a nexus-vox config's `mimi` section."""
    from nexus_vox.modules import transformer
    from nexus_vox.modules.dummy_quantizer import DummyQuantizer
    from nexus_vox.modules.seanet import SEANetDecoder, SEANetEncoder
